...
$otp = trim($_POST["otp"]);
$email_otp=$_SESSION["otp_database"];
  if($email_otp==$otp)
  {
      $_SESSION["otp_start"]=false;
      $user_email=$_SESSION["email_database"];
      $user_name=$_SESSION["username_database"];
      $user_password=$_SESSION["password_database"];
...
if ($stmt->execute()) {
    ...
    echo "<script>window.alert('*** SOMETHING WENT WRONG...TRY AGAIN LATER...');window.location='signup.php';</script>";
}
...
<head>
	...
	<meta name="description" content="Signup otp verification">
	<meta name="keywords" content="signup otp verification">
...
<body>
	...
	<div class="row" style="background:linear-gradient(25deg,pink,#abcdef);">
		<h5 style="color:black;background-color:orange;font-size:15px;padding:1px;">FOR SIGNUP<br>OTP Successfully Sent To Your Email..</h5>
		<br><h6 style="color:brown;font-weight:1000;font-size:15;"  class="information-text" id="otp"><b>Enter OTP To Continue...</b></h6>
...
<a href="signup_resend_otp.php" style="text-decoration:none;"><h2 style="background-color:black;color:pink;font-size:15px;">Resend OTP</h2></a>
			</form>
		</div>
		<div class="footer">
			<h5><a href="signup.php"><b style="color:black;">Go Back</b></a></h5>
			<h5><a href="signup.php"><b style="color:black;">For SignIn</b></a></h5>
		</div>
	</div>
</div>
</body>
