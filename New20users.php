...
$sql="select * from Myusers order by dofreg desc limit 20";
$result=$conn->query($sql);
?>
        <!DOCTYPE html>
        <html>
            <head>
                <title>New 20 Users...</title>
...
if($result)
{
    if($result->num_rows>0)
    {
        ?>
            ...
            <h3>Our Recently 20 New Users Are...</h3>
        ...
        <br>
        <h3>For All Users Information Click Here...</h3>
        <button type="button" class="button-87" role="button" id="button" onclick="AllUsers()">All Users</button>
        <br>
        <?php
