...
$username=$_SESSION["email_username"];
$otp=rand(100000,999999);
$sql2="update Myusers set otp=$otp where email='$email'";
$setOTP=$conn->query($sql2);
...
try {
    ...
    <i style="color:green;">Your One Time Password Is</i>&nbsp;&nbsp;<i style="color:red;">***'.$otp.'***</i>
    <br><br><br><br>
    <i style="color:#800080;font-size:30;">For Any Queries...<br>Contact Me In instagram<br></i></h4>
...
html:`
<div id='pc'>
If <b id='bold'>OTP</b> to your email is going to <b id='bold'>'SPAM' folder</b>,<br>Click on <b id='bold'>'Not Spam'</b> to receive emails directly to your <b id='bold'>'Inbox.'</b><br></p>
...
width:1000,
    ...
    window.location='otp_verification';
});
</script></body></html>";
} catch (Exception $e) {
